...
DEFAULT_LOGS_DIR = os.path.join("/scratch/surendra/logs/lstm/l2")
	...
	def load_data(self, dataset_dir, subset):
		...
		for a in annotations:
			...
			if ff[0] == 'illustrations':
				...
				# print('pih')
				# ff1 = '/PIH_images'+'/'+ff[1]
				image_path1 = input_dir + "/img" + str(i) + ".npy"
				image_path2 = input_dir + "/" + str(i) + ".jpg"
				# print(image_path)
			else:
				image_path1 = input_dir + "/img" + str(i) + ".npy"
				image_path2 = input_dir + "/" + str(i) + ".jpg"
